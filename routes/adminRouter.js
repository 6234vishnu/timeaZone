...
router.post('/otpcompareforgotAdmin',adminAuth,adminController.otpcompareforgotAdmin)
...
router.get('/editCategoryrender',adminAuth,categoryController.editCategoryrender)
...
router.post('/editProducts/:productId', upload.array('images', 3), productController.updateProduct);
router.delete('/deleteProductImage/:productId', adminAuth, productController.deleteProductImage);
router.post('/editProduct/:productId', upload.single('images'), productController.uploadCroppedImage);
